...
<html lang="{{ $lang == 'ar' ? 'ar' : 'en' }}" dir="{{ $lang == 'ar' ? 'rtl' : 'ltr' }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - @lang('station.panel_title')</title>
        ...
        <style>
            :root {
                --station-primary: #e65100;
                --station-primary-dark: #bf360c;
                --station-primary-light: #ff9800;
            }
            .bg-station {
                background-color: var(--station-primary) !important;
            }
            .bg-station-dark {
                background-color: var(--station-primary-dark) !important;
            }
            .text-station {
            ...
            .btn-station:hover {
                background-color: var(--station-primary-dark);
                border-color: var(--station-primary-dark);
                color: #fff;
            }
    ...
    <body>
        ...
        @include('layouts.station.incs._header')

        <div class="container-fluid">
            <div class="row">
                @include('layouts.station.incs._navbar')
                
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pb-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        @stack('title')
                        <div class="d-flex justify-content-center mb-2">
                            <div id="loddingSpinner" style="display: none" class="spinner-border text-station" role="status">
