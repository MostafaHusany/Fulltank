...
<div class="text-center">
    ...
    <div class="btn-group">
        ...
        <div class="dropdown-menu {{ !$is_ar ? '!dropdown-menu-right !dropdown-menu-lg-right' : '!dropdown-menu-left !dropdown-menu-lg-left' }}">
            ...
            {{--
            @if($permissions == 'admin' || in_array('services_add', $permissions))
            ...
            >
                <div class="row">
                    <div class="col-8 text-left">
                        <span>@lang('layouts.copy')</span>
                    </div>
                    <div class="col-4">
                        <i class="fas fa-copy float-end"></i>
                    </div>
                </div><!-- /.row -->
            </button>
            @endif
            ...
            <button class="dropdown-item delete-object text-danger" 
                data-object-id="{{$row_object->id}}" data-object-name="{{ $row_object->en_name . ' / ' . $row_object->ar_name }}"
            >
                <div class="row">
                    <div class="col-8 text-left">
