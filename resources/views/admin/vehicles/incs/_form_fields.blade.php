...
<div class="my-3 row g-2">
    <label for="{{ $prefix }}fuel_type_id" class="col-12 col-md-2 col-form-label">@lang('vehicles.Fuel Type') <span class="text-danger">*</span></label>
    <div class="col-12 col-md-10">
        <select class="form-select form-control" id="{{ $prefix }}fuel_type_id">
