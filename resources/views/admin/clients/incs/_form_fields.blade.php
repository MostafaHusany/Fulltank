...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}nameErr"></div>
    </div>
</div>
...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}company_nameErr"></div>
    </div>
</div>
...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}client_categoryErr"></div>
    </div>
</div>
...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}emailErr"></div>
    </div>
</div>
...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}phoneErr"></div>
    </div>
</div>
...
<div class="my-3 row g-2">
    ...
    <div class="col-12 col-md-10">
        ...
        <div class="err-msg mt-2 alert alert-danger d-none" id="{{ $prefix }}passwordErr"></div>
    </div>
</div>
